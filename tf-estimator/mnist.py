...
# Clusterone snippet 1
# Creates necessary TF_CONFIG environment variable for Estimator
try:
...
def get_args():
    ...
    # Clusterone snippet 2
    # Grabs the correct paths, depending on if the job is running local or on Clusterone
