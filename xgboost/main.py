...
def parse_args():
    ...
    opts.train_file_pattern = os.path.join(opts.absolute_data_dir, opts.train_file_pattern)
    opts.test_file_pattern = os.path.join(opts.absolute_data_dir, opts.train_file_pattern)
